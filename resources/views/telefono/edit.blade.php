            ...
            <div class="col">
                <form action="/telefono/{{$telefonoEdit->id}}" method="post"> <!--el motodo post apunta a la funcion store-->
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="CodPersona" class="form-control" value="{{$telefonoEdit->CodPersona}}" readonly onmousedown="return false;>
                    </div>

                    <div class="mb-3">
                        <label for="">Codigo Telefono</label>
                        <input type="text" name="CodTelefono" class="form-control" value="{{$telefonoEdit->CodTelefono}}" readonly onmousedown="return false;>
                    </div>
